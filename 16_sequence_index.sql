...
CREATE SEQUENCE dept2_seq 
    ...
    NOCACHE  -- 캐시 메모리 사용 여부(기본값은 CACHE) : NOCACHE로 하는 게 좋다. 
            -- 이유: 캐시는 미리 받아 놓은 시퀀스를 불러온다. 그런데 에러가 나면
            -- 다시 시퀀스를 받아오지 않고 이미 받아온 거 이후로 시퀀스를 가져오기 때문에 시퀀스가 틀어진다. 
